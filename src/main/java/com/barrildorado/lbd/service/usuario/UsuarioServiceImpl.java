...
public class UsuarioServiceImpl implements UsuarioService {
    ...
    @Override
    public void cambiarContraseñaDirecta(DatosActualizarContraseñaUsuarioAdmin datosActualizarContraseñaUsuarioAdmin) {
        Usuario usuario = usuarioRepository.findById(datosActualizarContraseñaUsuarioAdmin.id_usuario())
        .orElseThrow(() -> new RuntimeException("Usuario no encontrado"));
        
        String nuevaContraseña = datosActualizarContraseñaUsuarioAdmin.nueva_contraseña();
